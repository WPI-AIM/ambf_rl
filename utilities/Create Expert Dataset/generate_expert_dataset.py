...
if __name__ == "__main__":
    ...
    rosbag_file_dir = "path_to_rosbag file"
    rostopic_name = "/dvrk/PSM2/position_cartesian_current"
    csv_file_name = "path_to_csv_file"
    # Read rosbag data
    ...
    traj_csv_name = "path_to_where_rosbag_file_is_stored"
    trajectory_data_values = pd.read_csv(traj_csv_name).to_numpy()
